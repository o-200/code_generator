...
RSpec.describe CodeGenerator::Generator do
  describe "#generate_code" do
    ...
    describe "private_methods" do
      ...
      context "when Symbol is passed" do
        let(:code) { described_class.new(private_methods: :method1) }
        ...
        context "when options for method were passed" do
          let(:code) { described_class.new(private_methods: :method1, should_return: Integer, generate: true) }
      ...
      context "when Integer is passed" do
        let(:code) { described_class.new(private_methods: 2) }
        ...
        context "when there is any params" do
          let(:code) { described_class.new(private_methods: 2, should_return: Integer, generate: true) }
      ...
      context "when Array is passed" do
        context "when first value is any other object than String or Symbol" do
          let(:some_value) { 1 }
          let(:code) { described_class.new(private_methods: [[11, { should_return: 123 }]]) }
        ...
        context "when values are Symbol or String" do
          let(:code) { described_class.new(private_methods: [:method1, "method2"]) }
          ...
          context "when additional params were passed" do
            let(:code) do
              described_class.new(private_methods: [:method1, "method2"], should_return: Integer, generate: true)
            end
        ...
        context "when `should_return` passed" do
          context "when instance is passed" do
            ...
            let(:m2_value) { Integer }
            let(:code) do
              described_class.new(private_methods: [[:method1, { should_return: m1_value }],
                                                   [:method2, { should_return: m2_value }]])
            end
        ...
        context "when `generate` passed" do
          context "when it was passed in correct way" do
            subject(:code) do
              described_class.new(private_methods: [[:method1, { should_return: klass, generate: true }],
                                                   [:method2, { should_return: klass, generate: true }]])
            end
      ...
      context "when passed anything else" do
        let(:code) do
          described_class.new(private_methods: Object.new)
        end
      ...
      context "when passed arguments to methods" do
        subject(:code) { described_class.new(private_methods: [[:method1, { args: args }]]) }
